        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-700/50 flex-shrink-0">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              {values.length} of {options.length} team members selected
            </p>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6 flex-1 overflow-hidden">
          {options.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-slate-500 text-sm">Add team members in the Team Management tab to assign them to projects.</p>
            </div>
          ) : (
