...
export default function TaskList({ tasks, onToggleComplete, onDeleteTask, onEditTask }: TaskListProps) {
  ...
  return (
    <div className="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
      ...
      {/* Header row */}
      <div className="grid grid-cols-[24px_1fr_1fr_1fr_1fr_1fr_0.8fr_1fr_1fr_1fr_1fr_auto] items-center gap-0 px-3 py-1 text-[11px] font-semibold text-slate-300 tracking-wide bg-slate-900 border-b border-slate-700 divide-x divide-slate-700">
        <div></div>
